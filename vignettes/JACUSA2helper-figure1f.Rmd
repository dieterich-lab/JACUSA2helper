...
```
The following barplot summarizes the number of sites by characteristic base substitutions relative to the reference sequence.
We observe a lot more C-to-U transistions in the active YTH binding domain as compared to the inactivated binding domain.
