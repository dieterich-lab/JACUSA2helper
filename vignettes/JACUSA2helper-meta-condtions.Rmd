---
title: "Introduction to meta conditions with JACUSA2helper"
...
link-citations: yes
vignette: >
  %\VignetteIndexEntry{Introduction to meta conditions with JACUSA2helper}
...
<!-- TODO
#```{r}
#GenomicRanges::mcols(Zhou2018_rt_arrest) %>% as.data.frame() %>%
#  dplyr::distinct(contig, meta_cond) %>% 
